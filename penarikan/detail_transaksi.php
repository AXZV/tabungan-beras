<?php
	...
	if ($data2['s_penarikan'] == 'notclear')
	{
		...
		$query3 = "SELECT * FROM log_penarikan WHERE id_transaksi='$id_trans'";
...
<div class="card-body">
<p>Maaf anda belum bisa melakukan transaksi penarikan dikarenakan transkasi anda dengan detail</p>
