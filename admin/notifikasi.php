...

{
	...
	$results10 = $crud->get_order_by('log_tabungan', 'status', 'belum_diverifikasi', 'id');
	$lenght10=mysqli_num_rows($results10);

	$results11 = $crud->get_order_by('log_tabungan', 'status', 'belum_diverifikasi', 'id');

	$results2 = $crud->get_order_by('log_tabungan', 'status', 'sudah_diverifikasi', 'id');
	$lenght2=mysqli_num_rows($results2);

	$results21 = $crud->get_order_by('log_tabungan', 'status', 'sudah_diverifikasi', 'id');
