...
if (isset($_SESSION['s_admin_id']))
{
	...
	$results3 = $crud->get_riwayat_admin('log_tabungan', 'status', 'belum_diverifikasi');
	$lenght2=mysqli_num_rows($results3);

	$results4 = $crud->get_riwayat_admin('log_sedekah', 'status', 'belum_diverifikasi');
	$lenght4=mysqli_num_rows($results4);

	$results6 = $crud->get_riwayat_admin('log_penarikan', 'status', 'belum_diverifikasi');
