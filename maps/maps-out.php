...
<!--   <label for="formGroupExampleInput2">Alamat</label>
  <div class="input-group" id="search">   
    <input type="text" class="form-control" value="" id="addr" placeholder="Masukan alamat kos" required="">
      <div class="input-group-prepend">
        <button type="button" class="btn sikos-btn-color white m-0 btn-sm" onclick="addr_search();showResult();" style="border-radius: 0 .25rem .25rem 0">Cari</button>
      </div>
  </div> -->
<!--   <div id="results" class="border rounded p-2 grey lighten-4"></div> -->
  <div class="rounded-bottom" id="map"></div>
  <div class="form-group row d-none">
    <div class="col"><input type="text" readonly="" class="form-control" id="lat" name="lat" value=""></div>
    <div class="col"><input type="text" readonly="" class="form-control" id="lon" name="lon" value=""></div>
  </div>
<!--   <input type="text" readonly="" id="address" class="form-control mb-3" placeholder="Alamat" name="lokasi"> -->
</div>
...
var startlat = -6.8854537;
var startlon = 109.2377054;
